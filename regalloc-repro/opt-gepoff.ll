...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  ...
  %add11.i = or disjoint i32 %mul10.i, %rem52
  %arrayidx12.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add11.i
  ...
  %add23.i = add nuw nsw i32 %add11.i, 16
  %arrayidx26.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add23.i
  ...
  %add37.i = add nuw nsw i32 %add11.i, 32
  %arrayidx40.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add37.i
  ...
  %add51.i = add nuw nsw i32 %add11.i, 48
  %arrayidx54.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add51.i
  ...
  %add65.i = add nuw nsw i32 %add11.i, 64
  %arrayidx68.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add65.i
  ...
  %arrayidx75.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %11
  ...
  %add81.i = add nuw nsw i32 %11, 400
  %arrayidx83.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add81.i
  ...
  %add89.i = add nuw nsw i32 %11, 800
  %arrayidx91.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add89.i
  ...
  %add97.i = add nuw nsw i32 %11, 1200
  %arrayidx99.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add97.i
  ...
  %add105.i = add nuw nsw i32 %11, 1600
  %arrayidx107.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add105.i
  ...
  %38 = mul i8 %div220.i282, 5
  %rem111.i281.decomposed = sub i8 %rem111.i.lhs.trunc, %38
  ...
  %add228.i = or disjoint i32 %mul227.i, %rem52
  %arrayidx231.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add228.i
  ...
  %add242.i = add nuw nsw i32 %add228.i, 80
  %arrayidx245.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add242.i
  ...
  %add256.i = add nuw nsw i32 %add228.i, 160
  %arrayidx259.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add256.i
  ...
  %add270.i = add nuw nsw i32 %add228.i, 240
  %arrayidx273.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add270.i
  ...
  %add284.i = add nuw nsw i32 %add228.i, 320
  %arrayidx287.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(3) @lds_uchar, i32 %add284.i
  ...
  %add332.i = add nuw nsw i32 %mul331.i, 20
  %idxprom333.i = zext nneg i32 %add332.i to i64
  %arrayidx334.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(1) %twiddles.coerce, i64 %idxprom333.i
  %W.sroa.0.0.copyload67.i = load double, ptr addrspace(1) %arrayidx334.i, align 8, !tbaa !15, !alias.scope !12, !amdgpu.noclobber !10
  %W.sroa.41.0.arrayidx334.sroa_idx.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx334.i, i64 8
  ...
  %add359.i = add nuw nsw i32 %mul331.i, 21
  %idxprom360.i = zext nneg i32 %add359.i to i64
  %arrayidx361.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(1) %twiddles.coerce, i64 %idxprom360.i
  %W.sroa.0.0.copyload68.i = load double, ptr addrspace(1) %arrayidx361.i, align 8, !tbaa !15, !alias.scope !12, !amdgpu.noclobber !10
  %W.sroa.41.0.arrayidx361.sroa_idx.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx361.i, i64 8
  ...
  %add386.i = add nuw nsw i32 %mul331.i, 22
  %idxprom387.i = zext nneg i32 %add386.i to i64
  %arrayidx388.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(1) %twiddles.coerce, i64 %idxprom387.i
  %W.sroa.0.0.copyload69.i = load double, ptr addrspace(1) %arrayidx388.i, align 8, !tbaa !15, !alias.scope !12, !amdgpu.noclobber !10
  %W.sroa.41.0.arrayidx388.sroa_idx.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx388.i, i64 8
  ...
  %add413.i = add nuw nsw i32 %mul331.i, 23
  %idxprom414.i = zext nneg i32 %add413.i to i64
  %arrayidx415.i = getelementptr inbounds %struct.rocfft_complex, ptr addrspace(1) %twiddles.coerce, i64 %idxprom414.i
  %W.sroa.0.0.copyload70.i = load double, ptr addrspace(1) %arrayidx415.i, align 8, !tbaa !15, !alias.scope !12, !amdgpu.noclobber !10
  %W.sroa.41.0.arrayidx415.sroa_idx.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx415.i, i64 8
  ...
  %39 = load double, ptr addrspace(1) %arrayidx3.i.i, align 8, !tbaa !17, !noalias !12, !amdgpu.noclobber !10
  %mul5.i.i = fmul contract double %retval.sroa.0.0.copyload.i.i, %39
  %y10.i.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx3.i.i, i64 8
  %40 = load double, ptr addrspace(1) %y10.i.i, align 8, !tbaa !19, !noalias !12, !amdgpu.noclobber !10
  %mul11.i.i = fmul contract double %retval.sroa.5.0.copyload.i.i, %40
  %sub.i459.i = fsub contract double %mul5.i.i, %mul11.i.i
  %mul18.i.i = fmul contract double %retval.sroa.5.0.copyload.i.i, %39
  %mul25.i.i = fmul contract double %retval.sroa.0.0.copyload.i.i, %40
  ...
  %41 = load double, ptr addrspace(1) %arrayidx3.i469.i, align 8, !tbaa !17, !noalias !12, !amdgpu.noclobber !10
  %mul5.i470.i = fmul contract double %retval.sroa.0.0.copyload.i463.i, %41
  %y10.i471.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx3.i469.i, i64 8
  %42 = load double, ptr addrspace(1) %y10.i471.i, align 8, !tbaa !19, !noalias !12, !amdgpu.noclobber !10
  %mul11.i472.i = fmul contract double %retval.sroa.5.0.copyload.i465.i, %42
  %sub.i473.i = fsub contract double %mul5.i470.i, %mul11.i472.i
  %mul18.i474.i = fmul contract double %retval.sroa.5.0.copyload.i465.i, %41
  %mul25.i475.i = fmul contract double %retval.sroa.0.0.copyload.i463.i, %42
  ...
  %43 = load double, ptr addrspace(1) %arrayidx3.i488.i, align 8, !tbaa !17, !noalias !12, !amdgpu.noclobber !10
  %mul5.i489.i = fmul contract double %retval.sroa.0.0.copyload.i482.i, %43
  %y10.i490.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx3.i488.i, i64 8
  %44 = load double, ptr addrspace(1) %y10.i490.i, align 8, !tbaa !19, !noalias !12, !amdgpu.noclobber !10
  %mul11.i491.i = fmul contract double %retval.sroa.5.0.copyload.i484.i, %44
  %sub.i492.i = fsub contract double %mul5.i489.i, %mul11.i491.i
  %mul18.i493.i = fmul contract double %retval.sroa.5.0.copyload.i484.i, %43
  %mul25.i494.i = fmul contract double %retval.sroa.0.0.copyload.i482.i, %44
  ...
  %45 = load double, ptr addrspace(1) %arrayidx3.i507.i, align 8, !tbaa !17, !noalias !12, !amdgpu.noclobber !10
  %mul5.i508.i = fmul contract double %retval.sroa.0.0.copyload.i501.i, %45
  %y10.i509.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx3.i507.i, i64 8
  %46 = load double, ptr addrspace(1) %y10.i509.i, align 8, !tbaa !19, !noalias !12, !amdgpu.noclobber !10
  %mul11.i510.i = fmul contract double %retval.sroa.5.0.copyload.i503.i, %46
  %sub.i511.i = fsub contract double %mul5.i508.i, %mul11.i510.i
  %mul18.i512.i = fmul contract double %retval.sroa.5.0.copyload.i503.i, %45
  %mul25.i513.i = fmul contract double %retval.sroa.0.0.copyload.i501.i, %46
  ...
  %47 = load double, ptr addrspace(1) %arrayidx3.i526.i, align 8, !tbaa !17, !noalias !12, !amdgpu.noclobber !10
  %mul5.i527.i = fmul contract double %retval.sroa.0.0.copyload.i520.i, %47
  %y10.i528.i = getelementptr inbounds i8, ptr addrspace(1) %arrayidx3.i526.i, i64 8
  %48 = load double, ptr addrspace(1) %y10.i528.i, align 8, !tbaa !19, !noalias !12, !amdgpu.noclobber !10
  %mul11.i529.i = fmul contract double %retval.sroa.5.0.copyload.i522.i, %48
  %sub.i530.i = fsub contract double %mul5.i527.i, %mul11.i529.i
  %mul18.i531.i = fmul contract double %retval.sroa.5.0.copyload.i522.i, %47
  %mul25.i532.i = fmul contract double %retval.sroa.0.0.copyload.i520.i, %48
  ...
  %49 = insertelement <2 x double> poison, double %add456.i, i64 0
  %50 = insertelement <2 x double> %49, double %sub465.i, i64 1
  %mul.i183 = shl i32 %conv190, 4
  %mul4.i = shl i32 %conv191, 4
  %cond.i.i184 = select i1 %spec.select, i32 %mul.i183, i32 -1
  %51 = bitcast <2 x double> %50 to <4 x float>
  %52 = ptrtoint ptr %7 to i64
  %buffer_rsc.i.sroa.0.0.extract.trunc.i185 = trunc i64 %52 to i32
  %53 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.0.extract.trunc.i185)
  %ret.sroa.0.0.vec.insert.i.i = insertelement <4 x i32> poison, i32 %53, i64 0
  %buffer_rsc.i.sroa.0.4.extract.shift.i186 = lshr i64 %52, 32
  %buffer_rsc.i.sroa.0.4.extract.trunc.i187 = trunc nuw i64 %buffer_rsc.i.sroa.0.4.extract.shift.i186 to i32
  %54 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.4.extract.trunc.i187)
  %ret.sroa.0.4.vec.insert.i.i = insertelement <4 x i32> %ret.sroa.0.0.vec.insert.i.i, i32 %54, i64 1
  ...
  %55 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %mul4.i)
  tail call void @llvm.amdgcn.raw.buffer.store.v4f32(<4 x float> noundef %51, <4 x i32> noundef %ret.sroa.0.8.vecblend.i.i, i32 noundef %cond.i.i184, i32 noundef %55, i32 noundef 0) #7
  ...
  %56 = insertelement <2 x double> poison, double %add484.i, i64 0
  %57 = insertelement <2 x double> %56, double %sub493.i, i64 1
  %mul.i188 = shl i32 %conv216, 4
  %cond.i.i190 = select i1 %spec.select, i32 %mul.i188, i32 -1
  %58 = bitcast <2 x double> %57 to <4 x float>
  %59 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.0.extract.trunc.i185)
  %ret.sroa.0.0.vec.insert.i.i192 = insertelement <4 x i32> poison, i32 %59, i64 0
  %60 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.4.extract.trunc.i187)
  %ret.sroa.0.4.vec.insert.i.i195 = insertelement <4 x i32> %ret.sroa.0.0.vec.insert.i.i192, i32 %60, i64 1
  ...
  %61 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %mul4.i)
  tail call void @llvm.amdgcn.raw.buffer.store.v4f32(<4 x float> noundef %58, <4 x i32> noundef %ret.sroa.0.8.vecblend.i.i196, i32 noundef %cond.i.i190, i32 noundef %61, i32 noundef 0) #7
  ...
  %62 = insertelement <2 x double> poison, double %add512.i, i64 0
  %63 = insertelement <2 x double> %62, double %sub521.i, i64 1
  %mul.i197 = shl i32 %conv243, 4
  %cond.i.i199 = select i1 %spec.select, i32 %mul.i197, i32 -1
  %64 = bitcast <2 x double> %63 to <4 x float>
  %65 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.0.extract.trunc.i185)
  %ret.sroa.0.0.vec.insert.i.i201 = insertelement <4 x i32> poison, i32 %65, i64 0
  %66 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.4.extract.trunc.i187)
  %ret.sroa.0.4.vec.insert.i.i204 = insertelement <4 x i32> %ret.sroa.0.0.vec.insert.i.i201, i32 %66, i64 1
  ...
  %67 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %mul4.i)
  tail call void @llvm.amdgcn.raw.buffer.store.v4f32(<4 x float> noundef %64, <4 x i32> noundef %ret.sroa.0.8.vecblend.i.i205, i32 noundef %cond.i.i199, i32 noundef %67, i32 noundef 0) #7
  ...
  %68 = insertelement <2 x double> poison, double %add540.i, i64 0
  %69 = insertelement <2 x double> %68, double %sub549.i, i64 1
  %mul.i206 = shl i32 %conv270, 4
  %cond.i.i208 = select i1 %spec.select, i32 %mul.i206, i32 -1
  %70 = bitcast <2 x double> %69 to <4 x float>
  %71 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.0.extract.trunc.i185)
  %ret.sroa.0.0.vec.insert.i.i210 = insertelement <4 x i32> poison, i32 %71, i64 0
  %72 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.4.extract.trunc.i187)
  %ret.sroa.0.4.vec.insert.i.i213 = insertelement <4 x i32> %ret.sroa.0.0.vec.insert.i.i210, i32 %72, i64 1
  ...
  %73 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %mul4.i)
  tail call void @llvm.amdgcn.raw.buffer.store.v4f32(<4 x float> noundef %70, <4 x i32> noundef %ret.sroa.0.8.vecblend.i.i214, i32 noundef %cond.i.i208, i32 noundef %73, i32 noundef 0) #7
  ...
  %74 = insertelement <2 x double> poison, double %add568.i, i64 0
  %75 = insertelement <2 x double> %74, double %sub577.i, i64 1
  %mul.i215 = shl i32 %conv297, 4
  %cond.i.i217 = select i1 %spec.select, i32 %mul.i215, i32 -1
  %76 = bitcast <2 x double> %75 to <4 x float>
  %77 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.0.extract.trunc.i185)
  %ret.sroa.0.0.vec.insert.i.i219 = insertelement <4 x i32> poison, i32 %77, i64 0
  %78 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %buffer_rsc.i.sroa.0.4.extract.trunc.i187)
  %ret.sroa.0.4.vec.insert.i.i222 = insertelement <4 x i32> %ret.sroa.0.0.vec.insert.i.i219, i32 %78, i64 1
  ...
  %79 = tail call i32 @llvm.amdgcn.readfirstlane(i32 %mul4.i)
  tail call void @llvm.amdgcn.raw.buffer.store.v4f32(<4 x float> noundef %76, <4 x i32> noundef %ret.sroa.0.8.vecblend.i.i223, i32 noundef %cond.i.i217, i32 noundef %79, i32 noundef 0) #7
  ret void
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %80 = load i64, ptr addrspace(1) %arrayidx25, align 8, !tbaa !6, !amdgpu.noclobber !10
  %mul26 = mul i64 %80, %plength.0288
  %remaining.0287.frozen = freeze i64 %remaining.0287
  %.frozen = freeze i64 %80
  %div32 = udiv i64 %remaining.0287.frozen, %.frozen
  %81 = mul i64 %div32, %.frozen
  %rem29.decomposed = sub i64 %remaining.0287.frozen, %81
  %arrayidx34 = getelementptr inbounds i64, ptr addrspace(1) %stride_in.coerce, i64 %conv24291
  %82 = load i64, ptr addrspace(1) %arrayidx34, align 8, !tbaa !6, !amdgpu.noclobber !10
  %mul35 = mul i64 %82, %rem29.decomposed
  %add36 = add i64 %mul35, %offset_in.0290
  %arrayidx38 = getelementptr inbounds i64, ptr addrspace(1) %stride_out.coerce, i64 %conv24291
  %83 = load i64, ptr addrspace(1) %arrayidx38, align 8, !tbaa !6, !amdgpu.noclobber !10
  %mul39 = mul i64 %83, %rem29.decomposed
