; ModuleID = 'opt-extract-true-phid4.bc'
...
if.end833.sink.split:                             ; preds = %mylabel
  ...
  %37 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %buf_out.coerce, i64 %mul48
  %38 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %37, i64 %mul23
  %39 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %38, i64 %mul618
  %arrayidx.i612 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul630
  ...
  %arrayidx.i614 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul648
  ...
  %40 = select i1 %.cmp, i32 0, i32 84
  %add663 = add nuw nsw i32 %add91.i, %40
  %conv665 = zext nneg i32 %add663 to i64
  %mul666 = mul i64 %0, %conv665
  %arrayidx.i616 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul666
  ...
  %arrayidx.i618 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul684
  ...
  %arrayidx.i620 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul702
  ...
  %arrayidx.i622 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul720
  ...
  %arrayidx.i624 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul738
  ...
  %arrayidx.i626 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul756
  ...
  %arrayidx.i628 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul774
  ...
  %arrayidx.i630 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul792
  ...
  %arrayidx.i632 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul810
  ...
  %arrayidx.i634 = getelementptr %struct.rocfft_complex, ptr addrspace(1) %39, i64 %mul828
